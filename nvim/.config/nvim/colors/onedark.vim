...
let g:terminal_ansi_colors = [
  ...
  \ s:blue.gui, s:purple.gui, s:light_cyan.gui, s:comment_grey.gui
\]
...
call s:h("Delimiter", {"fg": s:dark_red}) " character that needs attention
...
call s:h("VertSplit", { "fg": s:special_grey , "bg": s:special_grey}) " the column separating vertically split windows
...
call s:h("TabLine", { "fg": s:white, "bg": s:special_grey }) " tab pages line, not active tab page label
call s:h("TabLineFill", {"bg": s:special_grey}) " tab pages line, where there are no labels
call s:h("TabLineSel", { "fg": s:black,"bg": s:yellow }) " tab pages line, active tab page label
...
call s:h("htmlTagName", { "fg": s:red, "gui": "bold" })
call s:h("htmlTitle", { "fg": s:white })

" JavaScript
call s:h("javascript", {"fg": s:white})
call s:h("javaScriptMember", {"fg": s:light_cyan})
...
call s:h("jsDocParam", { "fg": s:white })
...
call s:h("jsFuncCall", { "fg": s:white })
...
call s:h("phpParent", { "fg": s:dark_yellow })
...
call s:h("phpFunctions", { "fg": s:light_cyan })
...
call s:h("texOpt", { "fg": s:green })
call s:h("texBeginEndName", { "fg": s:yellow })
call s:h("texMathZone", { "fg": s:light_cyan })
call s:h("texMathMatcher", { "fg": s:light_cyan })
call s:h("texMathDelim", { "fg": s:light_cyan })
call s:h("texDelimiter", { "fg": s:dark_yellow })
call s:h("texSpecialChar", { "fg": s:dark_yellow })
call s:h("texCite", { "fg": s:light_cyan })
...
" Vim
call s:h("vimNotation", { "fg": s:light_cyan })
...
" vimwiki
call s:h("VimwikiLink", {"fg": s:cyan, "gui": "underline", "cterm": "underline"})
call s:h("VimwikiHeader2", {"fg": s:yellow})
call s:h("VimwikiHeader3", {"fg": s:dark_yellow})
call s:h("VimwikiHeader4", {"fg": s:dark_red})
call s:h("VimwikiHeader5", {"fg": s:purple})
...
" Nvim-tree
call s:h("NvimTreeNormal", {"bg": s:special_grey})
call s:h("NvimTreeCursorLine", {"bg": s:visual_grey})

" Indent-blankline-nvim
call s:h("IndentBlankLineChar", {"fg": s:comment_grey})
call s:h("IndentBlankLineSpaceChar", {"fg": s:gutter_fg_grey})
