...
function! airline#themes#onedark#refresh()
  ...
  let s:N3 = [ s:colors.green.gui, s:colors.special_grey.gui, s:term_green, '' ]
  ...
  let s:I2 = s:N2
  let s:I3 = [ s:colors.blue.gui, s:colors.special_grey.gui, s:term_blue, '' ]
  ...
  let s:R2 = s:N2
  let s:R3 = [ s:colors.red.gui, s:colors.special_grey.gui, s:term_red, '' ]
  ...
  let s:V2 = s:N2
  let s:V3 = [ s:colors.purple.gui, s:colors.special_grey.gui, s:term_purple, '' ]
