...
let s:colors = {
      ...
      \ "cyan": get(s:overrides, "cyan", { "gui": "#0aaeb3", "cterm": "38", "cterm16": "6" }),
      \ "light_cyan": get(s:overrides, "cyan", { "gui": "#56b6c2", "cterm": "34", "cterm16": "13" }),
      ...
      \ "special_grey": get(s:overrides, "special_grey", { "gui": "#333841", "cterm": "238", "cterm16": "15" }),
